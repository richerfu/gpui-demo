...
use gpui_component::{
    avatar::Avatar, badge::Badge, description_list::DescriptionList, divider::Divider,
    group_box::GroupBox, h_flex, tag::Tag, v_flex,
};
...
pub fn render(
    ...
    view.card(
        ...
        v_flex()
            ...
            .child(
                DescriptionList::new()
                    .columns(if is_compact { 1 } else { 2 })
            ...
            .child(
                GroupBox::new().title("Summary").child(
                    v_flex()
                        .gap_2()
